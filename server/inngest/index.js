...
//Inngest Function to save user data ro a database
...
// Inngest function to update user data in databases
                    ...
                    await step.run('send-task-reminder-mail', async ()=>{
                        await sendEmail({
                            ...
                            body: `<div style="max-width: 600px;">
                               ...
                               <p style="margin: 6px 0;"><strong>Due Date:</strong> ${new Date(task.due_date).
                                toLocaleDateString()}</p>
                           </div>

                           <a href ="${origin}" style="background-color: ##007bff; padding: 12px 24px; border-radious:5px
